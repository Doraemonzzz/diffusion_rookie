...
class Unet(nn.Module):
    def __init__(
            ...
            self.downs.append(
                nn.ModuleList(
                    [
                        ...
                        Residual(PreGroupNorm(dim_out, EfficientAttention(dim_out))),
        ...
        self.mid_attn = Residual(PreGroupNorm(mid_dim, SimpleAttention(mid_dim)))
            ...
            self.ups.append(
                nn.ModuleList(
                    [
                        ...
                        Residual(PreGroupNorm(dim_in, EfficientAttention(dim_in))),
